...
void GhostdomDragon::DragonInitialise(Dragon_Object &dragon)
{
	...
	m_iAureolaSd = m_SoundMgr->CreateSound(Ogre::String("(龙)柔风.wav"));
	m_iBiggerSd = m_SoundMgr->CreateSound(Ogre::String("(龙)bigger变大.mp3"));
	m_iHarmObjectSd = m_SoundMgr->CreateSound(Ogre::String("(龙)伤害女孩2.wav"));
