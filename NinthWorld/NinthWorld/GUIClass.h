/*--------------------------------------------------------------
【头文件】：GUIClass.h       Created by Beyond Ray,2013年2月
...
#define GUI_BKGROUND_PRESENT	5
#define GUI_BKGROUND_RENDER		6
...
#define GUI_BUTTON_FLYMODE	6
#define GUI_BUTTON_SKIP		7

//定义控件类型ID最大上限编号
#define GUI_TEXT_MAX		0
#define GUI_BUTTON_MAX		7
